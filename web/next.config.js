...
const ContentSecurityPolicy = `
  ...
  script-src 'self' ${process.env.NEXT_PUBLIC_BASE_URL} data: https://*.sanity.io  https://*.googleapis.com https://*.vercel-insights.com https://*.algolia.net https://*.algolianet.com https://*.algolia.io https://*.vercel.app/* https://*.googleapis.com 'sha256-XXX' https://*.emailjs.com 'unsafe-eval' unsafe-* https://*.gstatic.com;
