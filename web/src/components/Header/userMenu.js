    ...
    <>
      <div className="dropdown inline-block relative">
        ...
        <ul className="dropdown-menu absolute hidden text-gray-700 pt-1">
          ...
          <li className=""><a className="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap cursor-pointer" onClick={() => retour.push('/api/auth/logout')}>Logout</a></li>
        </ul>
      </div>
